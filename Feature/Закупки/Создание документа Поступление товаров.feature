...
// Блок User story описывается в произвольной форме. Необязательный
...
// Блок иии Сценарий. Может быть несколько. Состоит из шагов, которые полностью имитируют работу пользователя
